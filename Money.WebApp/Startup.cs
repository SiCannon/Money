...
namespace Money.WebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connection = @"Server=(localdb)\mssqllocaldb;Database=money;Trusted_Connection=True;ConnectRetryCount=0";
            services.AddDbContext<MoneyContext>(options => options.UseSqlServer(connection));
